...
Begin VB.Form frmPreviewPayroll 
   BorderStyle     =   0  'None
   ...
   Begin MOVERS.CandyButton ButPrev 
      ...
      Picture         =   "frmPreviewPayroll.frx":0000
      PictureAlignment=   2
      Checked         =   0   'False
   ...
   Begin VB.Image Image2 
      Height          =   435
      Left            =   30
      Picture         =   "frmPreviewPayroll.frx":077A
      Stretch         =   -1  'True
      Top             =   8025
      Width           =   12360
   End
   ...
   End
End
Attribute VB_Name = "frmPreviewPayroll"
...
Sub PrintPL(LiR As LynxGrid3)
    If MsgBox("Print this Payroll Report?", vbInformation + vbOKCancel, "Printing") = vbCancel Then Exit Sub
    ...
    PRImportListView cTP, LiR, IIf((chkColWidth.Value = vbChecked), Printer.ScaleWidth - 2 * 567, -1)
...
Private Sub Form_Load()
    ...
    frmPayrollReport.MousePointer = Normal
End Sub
...
Private Sub Form_Unload(Cancel As Integer)
    ...
    'rrr = frmPayrollReport.listEntries.RowCount - 7
    'rrR1 = frmPayrollReport.listEntries.RowCount
    'MsgBox rrr & "-" & rrR1
    '
    'For Li = rrr To rrR1
    '    frmPayrollReport.listEntries.RemoveItem (Li)
    'Next Li
...
Sub TransferDataList(LiR As LynxGrid3)
    ...
    ' to ScaleWidth - [the left and right margins] to get a fitting table !
    frmPayrollReport.MousePointer = vbHourglass
    PRImportListView cTP, LiR, IIf((chkColWidth.Value = vbChecked), picTarget.ScaleWidth - 2 * 567, -1), chkIcons.Value
