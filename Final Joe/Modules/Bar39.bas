...
'dimensions
obj.ScaleMode = 2.5                               'pixels
obj.Cls
obj.Picture = Nothing
dw = 1.4 'CInt(obj.ScaleHeight / 70)               'space between bars
If dw < 1 Then dw = 1
'Debug.Print dw
...
'MsgBox obj.TextHeight(bc_string)

Y1 = 10 'obj.ScaleTop '/ 2
Y2 = obj.ScaleTop + obj.ScaleHeight - 18  '1.5 '* Th '- 50
...
'final size and text
'obj.Height = 650
obj.Width = (xpos + dw) + 3740 'obj.Width - 200 / obj.ScaleWidth
obj.CurrentX = (obj.ScaleWidth - tw) / 2
obj.CurrentY = 0 'Y2 + 0.25 * Th - 2
obj.Print bc_string
